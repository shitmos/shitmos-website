document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadMetadataInBatches(start, end, batchName) {
        ...
        for (let i = start; i <= Math.min(end, start + BATCH_SIZE - 1); i++) {
            promises.push(fetch(`https://ipfs-gw.stargaze-apis.com/ipfs/bafybeify3c3kbvlefj63dklwuq5hlc3qsj4vuphsjuqj7hel2n6bc3vnkm/${i}.json`)
                .then(response => {
                    if (!response.ok) {
    ...
    async function displayImages(data) {
        for (let item of data) {
            ...
            const pngPath = `https://ipfs-gw.stargaze-apis.com/ipfs/bafybeify3c3kbvlefj63dklwuq5hlc3qsj4vuphsjuqj7hel2n6bc3vnkm/${imgId}.png`;
            const gifPath = `https://ipfs-gw.stargaze-apis.com/ipfs/bafybeify3c3kbvlefj63dklwuq5hlc3qsj4vuphsjuqj7hel2n6bc3vnkm/${imgId}.gif`;
