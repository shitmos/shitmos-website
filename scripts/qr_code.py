...
# Input data
data = "https://www.stargaze.zone/m/proto-towers/tokens"
file_name = "proto_towers.png"
logo_path = None  # Set to None if you don't want a logo; add the path if you want a logo
